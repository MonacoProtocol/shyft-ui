...
A UI for the monaco protocol built using the [shyft graphQL API](https://shyft.to/). Built using [nextJS](https://nextjs.org/) and the [nextUI](https://nextui.org/) framework.
